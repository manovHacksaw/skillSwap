...
interface WalletConnectProps {
  onWalletConnected: (walletData: { address: string; signature: string }) => void
  isLoading?: boolean
}

export default function WalletConnect({ onWalletConnected, isLoading = false }: WalletConnectProps) {
    ...
    <div className="space-y-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600 font-medium max-w-2xl mx-auto">
          Link your learning journey to your wallet to store certificates, manage rewards, and ensure ownership of your
          achievements.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
        <Card className="border-2 border-black shadow-lg">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-gray-600">Your wallet proves ownership of your learning achievements</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 border-black shadow-lg">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-gray-600">Earn blockchain-verified certificates for completed skills</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 border-black shadow-lg">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-gray-600">Build verifiable reputation that follows you everywhere</p>
          </CardContent>
        </Card>
      </div>
          ...
          {!walletAddress ? (
            <>
              <div className="flex items-center justify-center gap-2 text-amber-700">
                ...
                <span className="font-medium">Wallet connection required to continue</span>
              </div>
              <Button
            ...
            <div className="space-y-3">
              ...
              <h3 className="text-lg font-bold text-black">Wallet Connected!</h3>
              <p className="text-sm text-gray-600">
                Connected to: {walletAddress.slice(0, 6)}...{walletAddress.slice(-4)}
              </p>
              {isLoading && <p className="text-sm text-gray-600">Completing your setup...</p>}
            </div>
          )}
        </CardContent>
      </Card>
